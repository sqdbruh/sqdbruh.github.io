...
badd +45 index.html
badd +327 styles.css
badd +22 C:/dev/sqdbruh.github.io/content.json
argglobal
%argdel
edit styles.css
...
argglobal
balt C:/dev/sqdbruh.github.io/content.json
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 327 - ((46 * winheight(0) + 26) / 52)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 174 - ((8 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 174
